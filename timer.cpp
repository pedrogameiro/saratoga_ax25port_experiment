...
static const int SEC_CONVERTER =
  1000; // os valores passados no ficheiro de configuracao
// estao em ms
...
{ // Falta fazer *********************************************
  // return false;
  return timedout();
  // return (((saratoga::offset_t) clock() - begTime) / CLOCKS_PER_SEC) >=
  // elapsedTime;
}
void
timer::reset()
...
timer::timedout()
{
  ...
  chrono::duration<long> time_span =
    chrono::duration_cast<chrono::duration<long>>(actual - begTime);
